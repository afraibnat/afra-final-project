    ...
    {#snippet scrolly()}
        <ArticleText>
            ...
            <p>
                ...
                their own to rely on self-sufficiency.
            </p>
            <p>
                As a result, there came the “Golden Age” of Black-owned
                businesses from 1900 to 1930. The number of Black-owned
                companies doubled from 20,000 to 40,000 between 1900 and 1915,
                according to the National Negro Business League.
            </p>
            <p>
                ...
                meeting ground for black leaders.
            </p>
        </ArticleText>
    {/snippet}
</Scroller>
