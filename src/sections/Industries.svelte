    ...
    const simpleCallback = (entries, observer) => {
        entries.forEach((entry) => {
            ...
            if (entry.intersectionRatio >= 0.9) {
                // "active" state
                elem.style.backgroundColor = "#00C3C9";
...
<Scroller layout="center">
    {#snippet sticky()}
        ...
        <p>
            These are industries with some of the <a
    ...
    {#snippet scrolly()}
        <ObserverArticleSecond callback={simpleCallback} {options}>
            <p>
                <strong>Accommodations,</strong> specifically
                <strong>Hotel</strong>
                and <strong>Leisure:</strong> Down by <strong>35%</strong>
            </p>
        </ObserverArticleSecond>

        <ObserverArticleSecond callback={simpleCallback} {options}>
            <p>
                <strong>Food service (Restaurants):</strong> Down by
                <strong>22%</strong>
            </p>
        </ObserverArticleSecond>
        ...
        <ObserverArticleSecond callback={simpleCallback} {options}>
            <p>
                <strong>Construction:</strong> Down by <strong>27%</strong>
            </p>
        </ObserverArticleSecond>
        ...
        <ObserverArticleSecond callback={simpleCallback} {options}>
            <p>
                ...
                Down by <strong>18%</strong>
            </p>
        </ObserverArticleSecond>

        <ObserverArticleSecond callback={simpleCallback} {options}>
            <p>
                <strong>Health Services:</strong> Down by
                <strong>16%</strong>
            </p>
        </ObserverArticleSecond>
    {/snippet}
